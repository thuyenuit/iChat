...
public final class FriendDB {
    ...
    public long CheckUser(String id) {
        SQLiteDatabase db = mDbHelper.getWritableDatabase();
        return DatabaseUtils.queryNumEntries(db, FeedEntry.TABLE_NAME  +  " WHERE " + FeedEntry.COLUMN_NAME_ID +"='"+ id +"'");
    }

    public void UpdateAvata( String id, String avata) {
        SQLiteDatabase db = mDbHelper.getWritableDatabase();

        String updateFrom = "UPDATE " + FeedEntry.TABLE_NAME;
        String setUpdate = " SET " + FeedEntry.COLUMN_NAME_AVATA + "='"+ avata +"'";
        String where = " WHERE " + FeedEntry.COLUMN_NAME_ID +"='"+ id +"'";
        db.execSQL(updateFrom + setUpdate +  where);
    }
    ...
    public void UpdateUserName(String id, String userName) {
        ...
        String updateFrom = "UPDATE " + FeedEntry.TABLE_NAME;
        String setUpdate = " SET "  +  FeedEntry.COLUMN_NAME_NAME + "='"+ userName +"'";
        String where = " WHERE " + FeedEntry.COLUMN_NAME_ID +"='"+ id +"'";
        db.execSQL(updateFrom + setUpdate +  where);
    }
