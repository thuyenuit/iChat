package com.example.thuyenbu.uitchat.utils;
...
public class ImageUtils {
    ...
    public static RoundedBitmapDrawable SetImage(Context context, Bitmap src){
        Resources res = context.getResources();
        RoundedBitmapDrawable dr = RoundedBitmapDrawableFactory.create(res, src);
       //dr.setCornerRadius(Math.max(src.getWidth(), src.getHeight()) / 1.1f);
